...
- Pricing: Free tier is 15 requests/day, no card required. Pay-per-call is $0.04/call once over the free daily limit (drops to $0.015/call once subscribed), top up $5-$500 anytime. Subscription is $45 for 5000 calls/30 days, manual renewal (Solana Pay can't auto-charge). x402 (no key, autonomous agents) is $0.02/call.
