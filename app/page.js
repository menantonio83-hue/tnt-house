...
export default function TntHouse() {
  ...
  // SOLANA PAY + GOOGLE SHEETS (как ты просил)
  const handleFormSubmit = (e) => {
    ...
    if (selectedTier === 'fast') mrdtAmount = 3000000;
    if (selectedTier === 'vip') mrdtAmount = 9200000;
    ...
    setTimeout(() => {
      ...
      setLogs(prev => [...prev.slice(-12), 
        `[${new Date().toLocaleTimeString()}] [✅ ОПЛАТА] Заявка "${formData.projectName}" — оплата отправлена. Токен добавлен в таблицу!`
      ]);
  ...
  const handleSendChat = async (e) => {
    ...
    setTimeout(() => {
      const responses = [
        ...
        'Проверяю холдеров... Бандлов не обнаружено.',
        '$MRDT — это железобетонный гем! 🧱⚽️',
      ...
      <div className="relative z-10">
          ...
          <div className="max-w-7xl mx-auto px-6 py-6 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <span className="text-[10px] text-purple-400 block font-bold tracking-widest">TOP NEW TOKENS v1.1</span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2">
              <div className="relative">
                ...
                {isBuyDropdownOpen && (
                  <div className="absolute right-0 mt-2 w-48 bg-slate-900 border border-purple-500/30 rounded-lg shadow-xl z-50 py-1 text-sm">
                    <button onClick={() => { setIsBuyDropdownOpen(false); /* Jupiter logic if needed */ }} className="w-full text-left px-4 py-2.5 hover:bg-purple-500/10 text-emerald-400 flex items-center gap-2 text-sm">
              ...
              <button onClick={() => {}} className="bg-gradient-to-r from-purple-500 to-emerald-400 hover:from-purple-400 hover:to-emerald-300 text-slate-950 font-black px-4 py-2 rounded text-xs transition duration-300 shadow-[0_0_15px_rgba(153,69,255,0.4)]">
                CONNECT WALLET
              </button>
            </div>
          </div>
                ...
                <tbody>
                  ...
                  >
                    ...
                    <td className="p-2 text-right">
                      <button onClick={(e) => { e.stopPropagation(); /* open jupiter if needed */ }} className="inline-flex items-center gap-1 text-[11px] text-emerald-400 hover:text-emerald-300 font-bold hover:underline">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-4">
              ...
              <p className="text-slate-300 text-sm leading-relaxed">
                Заполни форму → Оплати $MRDT через Solana Pay → Токен автоматически появляется в таблице с оценкой!
              </p>
        ...
        <footer className="border-t border-purple-500/20 mt-12 py-6 bg-slate-950/60 backdrop-blur-lg">
          <div className="max-w-7xl mx-auto px-6 text-center space-y-2">
            <div className="text-purple-400 font-bold text-sm tracking-widest">TNT HOUSE v1.1 • SOLANA PAY</div>
