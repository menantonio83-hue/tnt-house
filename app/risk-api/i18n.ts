...
export const RISK_API_TRANSLATIONS: Record<LangCode, RiskApiTranslations> = {
  en: {
    ...
    payPerCallFeature3: 'Drops to $0.015/call once subscribed',
  ...
  es: {
    ...
    payPerCallFeature3: 'Baja a $0.015/llamada con suscripción activa',
  ...
  fr: {
    ...
    payPerCallFeature3: 'Descend à $0.015/appel avec un abonnement actif',
  ...
  el: {
    ...
    payPerCallFeature3: 'Πέφτει στα $0.015/κλήση μόλις γίνεις συνδρομητής',
  ...
  ru: {
    ...
    payPerCallFeature3: 'Падает до $0.015/запрос при активной подписке',
  ...
  it: {
    ...
    payPerCallFeature3: 'Scende a $0.015/chiamata con abbonamento attivo',
  ...
  zh: {
    ...
    payPerCallFeature3: '订阅后降至 $0.015/次',
    tierSubscription: '订阅',
